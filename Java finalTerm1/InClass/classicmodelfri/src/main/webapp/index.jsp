...
<html>
<head>
    <title>Europe-Classic-cars</title>
...
<%--    <div>--%>
<%--        Send Request to: <input type="text" id="url" class=" form-control">--%>
<%--    </div>--%>
<%--    <button onclick="testAjax()" class="ml-2 btn btn-warning">Call Servlet with Ajax</button>--%>
<%--</div>--%>
<%--<hr>--%>
<%--<div id="result">--%>
<%--    This is result ...--%>
        ...
        <div class="collapse navbar-collapse" id="mynavbar">
            <ul class="navbar-nav me-auto">
                ...
                <li class="nav-item ml-4">
                    <a class="nav-link text-light" href="javascript:showLoginForm()"><i class="bi bi-box-arrow-in-right"></i>Login</a>
                </li>
            </ul>
            <div style="margin-right: 20px">
                <img src="assets/images/cart.png" alt="Cart" width="42" onclick="viewCart()">
